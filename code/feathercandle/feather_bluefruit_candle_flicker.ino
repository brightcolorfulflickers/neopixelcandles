 ...
 * 
 * This code was mostly created by Adafruit. I combined and edited 
 * some things.
 * https://learn.adafruit.com/led-candles-simple-easy-cheap/overview
 * https://learn.adafruit.com/bluetooth-controlled-neopixel-headphones/software
 */
...
void set_color(byte index) {
  ...
  if (index >= INDEX_MIN)
    pixel.setPixelColor(0, index, (index * 3) / 8, 0);
  else if (index < INDEX_MIN)
    pixel.setPixelColor(0, index, (index * 3.25) / 8, 0);
...
void loop(void) {
  ...
  // Buttons
  if (packetbuffer[1] == 'B' || isAnimating) {
    isAnimating = true;
    if (packetbuffer[1] == 'B') {
